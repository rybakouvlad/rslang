...
export const data: Array<IDev> = [
  ...
  },
  {
    ...
    position: 'Software Enginer',
    discription:
      'Реализовал главную страницу, стилизацию, анимацию, а также видеоплеер для неё, реализовал пользовательскую игру, создал основу для вкладки «О разработчиках».',
  ...
  },
  {
    ...
    position: 'Software Enginer',
    discription:
      'Реализовал игру «Саванна», так же страницу настроек, их отображение, а так же логику работы, частично реализовал компонент карточки, «последовательное» вопроизведение слова и его перевод.',
  ...
  },
  {
    ...
    position: 'Software Enginer',
    discription:
      'Реализовал страницу «О нас», страницу учебника, визуальную часть и логику по работе с ним, навигацию для работы с учебником и словарём реализовал несколько графиков для статистики, работа над стилизацией приложения.',
